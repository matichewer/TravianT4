<h1><img class="unit u16" src="img/x.gif" alt="Caballero Teutón" title="Caballero Teutón" /> Caballero Teutón <span class="tribe">(Teutones)</span></h1>
...
<img id="big_unit" class="big_u16" src="img/x.gif" alt="Caballero Teutón" title="Caballero Teutón" /><div id="t_desc">El Caballero Teutón es un guerrero formidable que siembra miedo y desesperación entre sus enemigos. En defensa destaca contra la caballería enemiga. Sin embargo, el costo de entrenarlo y alimentarlo es extraordinario.</div><div id="prereqs"><b>Requisitos</b><br /><a href="manual.php?typ=4&amp;gid=22">Academia</a> Nivel 15, <a href="manual.php?typ=4&amp;gid=20">Establo</a> Nivel 10</div><map id="nav" name="nav">
